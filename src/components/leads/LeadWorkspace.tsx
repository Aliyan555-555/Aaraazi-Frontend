...
export function LeadWorkspace({ user, onNavigate, onCreateLead }: LeadWorkspaceProps) {
  // State
    ...
    >
      ...
      <div className="mb-3">
        ...
        <div className="w-full bg-gray-200 rounded-full h-2">
          <div
            className={`h-2 rounded-full ${lead.qualificationScore >= 70
              ? 'bg-green-500'
      ...
      <td className="px-4 py-3">
        <div className="flex items-center gap-2">
          ...
          <div className="w-16 bg-gray-200 rounded-full h-1.5">
            <div
              className={`h-1.5 rounded-full ${lead.qualificationScore >= 70
                ? 'bg-green-500'
                : lead.qualificationScore >= 40
                  ? 'bg-yellow-500'
                  : 'bg-red-500'
