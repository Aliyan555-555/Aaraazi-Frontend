...
export function addTaskComment(
  ...
  if (task) {
    ...
    logTaskActivity(taskId, user.id, user.name, "comment-added", {
      comment: newComment,
    });
  }
...
export function addTimeEntry(
  ...
  if (task) {
    ...
    logTaskActivity(taskId, user.id, user.name, "time-logged", {
      entry: newEntry,
    });
  }
...
export function calculateAgentWorkload(
  ...
  const completionRate =
    agentTasks.length > 0 ? (totalCompleted / agentTasks.length) * 100 : 0;
  const avgCompletionTime =
    completionCount > 0 ? completionTimeSum / completionCount : 0;
...
function logTaskActivity(
  ...
  console.log(`Task Activity: ${action}`, {
    taskId,
    userId,
    userName,
    metadata,
  ...
  return [
    {
      ...
      checklist: [
        {
          id: "1",
          title: "Review previous conversation notes",
          completed: false,
        },
        ...
        {
          id: "4",
          title: "Schedule next follow-up if needed",
          completed: false,
        },
      ],
      tags: ["follow-up", "call"],
    ...
    },
    {
      ...
      checklist: [
        {
          id: "1",
          title: "Confirm viewing time with client",
          completed: false,
        },
...
function getDefaultAutomationRules(): TaskAutomationRule[] {
  ...
  return [
    // ==================== LEAD AUTOMATION ====================
    {
      ...
      description:
        "Automatically create first contact task when a new lead is created",
      enabled: true,
      trigger: {
        type: "entity-created",
        entityType: "lead",
      ...
      taskTemplate: {
        ...
        description:
          "Make initial contact with the new lead within 2 hours. Introduce yourself, understand their requirements, and build rapport.",
        category: "follow-up",
        priority: "urgent",
        ...
        checklist: [
          {
            id: "1",
            title: "Review lead information and source",
            completed: false,
          },
    ...
    },
    {
      ...
      description:
        "Create task to send detailed requirement form when lead is qualified",
      enabled: true,
      trigger: {
      ...
      taskTemplate: {
        ...
        description:
          "Lead has been qualified. Send them the detailed requirements form to capture exact specifications.",
        category: "follow-up",
        priority: "high",
        dueInDays: 1,
        assignTo: "agent",
        ...
        checklist: [
          ...
          {
            id: "3",
            title: "Follow up to ensure form is filled",
            completed: false,
          },
        ],
      },
    ...
    // ==================== DEAL AUTOMATION ====================
    {
      ...
      description:
        "Create task to prepare sale agreement when new deal is created",
      enabled: true,
      trigger: {
        type: "entity-created",
        entityType: "deal",
      ...
      taskTemplate: {
        ...
        description:
          "Prepare the sale agreement document with all terms and conditions.",
        category: "documentation",
        priority: "high",
        dueInDays: 2,
        assignTo: "agent",
        ...
        checklist: [
          {
            id: "1",
            title: "Gather buyer and seller information",
            completed: false,
          },
          ...
          {
            id: "4",
            title: "Send to both parties for review",
            completed: false,
          },
        ],
      },
    ...
    },
    {
      ...
      description:
        "Create document collection task when deal reaches documentation stage",
      enabled: true,
      trigger: {
        type: "entity-status-changed",
        entityType: "deal",
      ...
      taskTemplate: {
        ...
        description:
          "Collect all required documents from buyer and seller for the transaction.",
        category: "documentation",
        priority: "high",
        dueInDays: 3,
        assignTo: "agent",
        ...
        checklist: [
          {
            id: "1",
            title: "Collect buyer CNIC and documents",
            completed: false,
          },
          {
            id: "2",
            title: "Collect seller ownership documents",
            completed: false,
          },
    ...
    },
    {
      ...
      taskTemplate: {
        ...
        description:
          "Payment is overdue. Contact buyer immediately to resolve.",
        category: "follow-up",
        priority: "urgent",
        dueInDays: 0,
        assignTo: "agent",
    ...
    // ==================== PROPERTY AUTOMATION ====================
    {
      ...
      description:
        "Create viewing preparation task when property becomes available",
      enabled: true,
      trigger: {
        type: "entity-status-changed",
        entityType: "property",
      ...
      taskTemplate: {
        ...
        checklist: [
          ...
          {
            id: "3",
            title: "Prepare property information sheet",
            completed: false,
          },
    ...
    },
    {
      ...
      description:
        "Create task to process offer when property status changes to under-offer",
      enabled: true,
      trigger: {
        type: "entity-status-changed",
        entityType: "property",
      ...
      taskTemplate: {
        ...
        checklist: [
          ...
          {
            id: "4",
            title: "Finalize acceptance or rejection",
            completed: false,
          },
        ],
      },
    ...
    // ==================== CONTACT AUTOMATION ====================
    {
      ...
      taskTemplate: {
        ...
        description:
          "Regular check-in with VIP investor contact to maintain relationship.",
        category: "follow-up",
        priority: "medium",
        dueInDays: 30,
        assignTo: "agent",
...
export function triggerAutomation(
  ...
  rules.forEach((rule) => {
    ...
    if (
      ...
      rule.trigger.entityType !== trigger.entityType
    )
      return;
    ...
    if (
      rule.taskTemplate.assignTo === "specific-user" &&
      rule.taskTemplate.specificUserId
    ) {
